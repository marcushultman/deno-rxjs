...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _main_components_progress_bar_progress_bar_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var _main_components_toolbar_toolbar_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    function AppComponent_menu_item_5_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(sidebarService, toolbarService, progressBar, activatedRoute) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 10,
      vars: 1,
      consts: [["hasBackdrop", "false"], ["mode", "side"], ["sidebar", ""], [3, "item", "url", 4, "ngFor", "ngForOf"], [1, "rxjs-content"], [3, "item", "url"]],
  ...
  function srcAppMainComponentsMenuItemMenuItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MenuItemComponent = /*#__PURE__*/function () {
      function MenuItemComponent(router, sideBarService, activatedRoute) {
      ...
      _createClass(MenuItemComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.activatedRoute.url.subscribe({
            next: function next(segments) {
              var url = segments.join('/');
              console.log(_this2.activatedRoute);

              if (_this2.item.url) {
                if ((_this2.item.url.startsWith('/') ? _this2.item.url : '/' + _this2.item.url) === url) {
                  if (_this2.item.children && _this2.item.children.length) {
                    console.log('ok');
    ...
    var ToolbarComponent = /*#__PURE__*/function () {
      ...
      _createClass(ToolbarComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.toolbarService.getNavigation().subscribe({
            next: function next(data) {
              _this4.navigationList = data.NavBar;
            },
            error: function error(data) {
              console.error(data);
            },
            complete: function complete() {
              _this4.progressBar.hide();
            }
          });
          this.sideBarService.sidebar.subscribe({
            next: function next(data) {
              _this4.menuView = data;
            }
          });
        }
      }, {
      ...
      _createClass(ToolbarService, [{
        ...
        value: function getNavigation() {
          ...
          return new rxjs__WEBPACK_IMPORTED_MODULE_0__["Observable"](function (subscriber) {
            _this5.http.get('content/navigation.json').subscribe({
              next: function next(data) {
