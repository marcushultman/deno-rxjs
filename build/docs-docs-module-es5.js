...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["docs-docs-module"], {
  ...
  function srcAppMainPagesDocsDocsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _use_angular_markdown__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var DocsComponent = /*#__PURE__*/function () {
      function DocsComponent(matStackBar, docsService, progressBar, activatedRoute, router, sideBarService, markdownService) {
      ...
      _createClass2(DocsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.markdownService.renderer.heading = function (text, level) {
            ...
            return "<h".concat(level, ">\n               <a id=\"").concat(escapedText, "\" routerLink=\".\" class=\"anchor\" routerLink=\".\">\n                 <span class=\"header-link\">").concat(text, "</span>\n               </a>\n             </h").concat(level, ">");
          };

          this.activatedRoute.fragment.subscribe(function (fragment) {
            _this7.fragment = fragment;
          });
    ...
    DocsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_use_angular_markdown__WEBPACK_IMPORTED_MODULE_6__["UseMarkdownComponent"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DocsComponent, [{
        ...
        return [{
          ...
          type: _use_angular_markdown__WEBPACK_IMPORTED_MODULE_6__["UseMarkdownService"]
        }];
      }, {
        docs: [{
      ...
      _createClass2(DocsService, [{
        ...
        value: function getConfig() {
          ...
          return new rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"](function (subscriber) {
            _this8.http.get(_this8.DOCS_PATH + 'guide.json').subscribe({
              next: function next(data) {
