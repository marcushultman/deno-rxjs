...
const _c0 = ["docs"];
class DocsComponent {
    constructor(matStackBar, docsService, progressBar, activatedRoute, router, sideBarService) {
...
DocsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function DocsModule_Factory(t) { return new (t || DocsModule)(); }, providers: [
        _docs_service__WEBPACK_IMPORTED_MODULE_3__["DocsService"]
    ], imports: [[
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DocsModule, [{
        ...
        args: [{
                declarations: [
                    _docs_component__WEBPACK_IMPORTED_MODULE_2__["DocsComponent"]
                ],
                imports: [
                    _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes),
                    ngx_markdown__WEBPACK_IMPORTED_MODULE_4__["MarkdownModule"].forRoot(),
...
class DocsService {
    ...
    loadFile(filename) {
        ...
        return this.http.get(this.DOCS_PATH + filename + '.md', { headers, responseType: 'text' });
    }
}
